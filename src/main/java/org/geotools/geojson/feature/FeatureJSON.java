...
public class FeatureJSON {
    ...
    boolean encodeColumnUpperCase = false;
    ...
    public void setEncodeColumnNameToUpperCase(boolean encodeColumnUpperCase) {
        this.encodeColumnUpperCase = encodeColumnUpperCase;
    }
        ...
        public String toJSONString(SimpleFeature feature) {
            ...
            for (int i = 0; i < featureType.getAttributeCount(); i++) {
                ...
                if (value instanceof Envelope) {
                    ...
                    if (encodeColumnUpperCase) {
                      entry(ad.getLocalName().toUpperCase(), value, sb);
                    } else {
